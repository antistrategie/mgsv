...
{
    [UnityEditor.AssetImporters.ScriptedImporter(1, "fmdl")]
    public class FmdlImporter : UnityEditor.AssetImporters.ScriptedImporter
    {
        ...
        private void ReadWithAssetImportContext(UnityEditor.AssetImporters.AssetImportContext ctx, string filePath)
        {
            Fmdl fmdl = new Fmdl(Path.GetFileNameWithoutExtension(filePath));
            fmdl.Read(filePath);
